...
const gongjisahang = [
  ...
  },
  {
    ...
    content: "고객님께서 가장 선호하는 데이트 장소는 어느 곳인지 자유롭게 골라주시면 됩니다" , link:"/" , linkcontent:'설문하러가기'
  }
];
      ...
      <table className={Style.boardTable}>
        <tbody>
          <tr>
            <th>제목</th>
            <td>
              {gongjisahang[dnum - 1].title}
            </td>
          </tr>
          <tr>
            <th>작성자</th>
            <td>
              {gongjisahang[dnum - 1].writer}
            </td>
          </tr>
          <tr style={{ height: '400px' }}>
            <th>내용</th>
            <td>
              {gongjisahang[dnum - 1].content}
              <br /><br /><br />
              <a href={`${gongjisahang[dnum-1].link}`}>{gongjisahang[dnum-1].linkcontent}</a>
            </td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
            <th colSpan={2} style={{ textAlign: 'center' }}>
              <button className={Style.button} style={{ border: 'none' }}>삭제</button>&nbsp;
